...
int main() {
    ...
    //medir_rendimiento("secp256r1", NID_X9_62_prime256v1, 1000, "Native1_ecdsa256r11.csv");
    medir_rendimiento("secp384r1", NID_secp384r1, 1000, "Native1_ecdsa384r11.csv");
    return 0;
}
