...
void run_rsa_benchmark(int bits, int n_iterations, const char *filename) {
    ...
    printf("Tiempo total de ejecución: %.3f ms (Desviación estándar: %.3f ms)\n", total_avg, total_std);
...
int main() {
    ...
    //run_rsa_benchmark(2048, n_iterations, "Native_rsa2048.csv");
    run_rsa_benchmark(4096, n_iterations, "Native_rsa4096.csv");
