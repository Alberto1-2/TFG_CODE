...
# Crear gráficos
files = ["ecdsa_secp256r1.csv", "ecdsa_secp384r1.csv"]

# Crear un diccionario para almacenar los tiempos totales por versión de ECDSA
data = {"ecdsa_secp256r1": [], "ecdsa_secp384r1": []}
...
plt.boxplot([data["ecdsa_secp256r1"], data["ecdsa_secp384r1"]],
            labels=["ecdsa_secp256r1", "ecdsa_secp384r1"],
